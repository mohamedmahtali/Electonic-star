...
@Slf4j
@Component
public class LdlcCrawler extends BaseCrawler {
    ...
    protected void crawlProduct(Product product) throws Exception {
        ...
        String searchUrl = "https://www.ldlc.com/recherche/" + product.getMpn();
        Document doc = fetchPage(searchUrl);

        Element priceEl = doc.selectFirst(".price .price");
        Element stockEl = doc.selectFirst(".stock-web .in-stock");
        Element linkEl = doc.selectFirst("a.pdt-item");
        ...
        String url = linkEl != null ? "https://www.ldlc.com" + linkEl.attr("href") : searchUrl;
